<?php
$conn = mysqli_connect("localhost", "root", "test", "bank");
if($conn-> connect_error){
	die("connection failed:". $conn-> connect_error);
}
$sql = "SELECT name, email, credits FROM Customers";
error_reporting(0);
...
<form action="" method="GET" class = "form">
	...
	<?php
			...
			if($u1!="" && $u2!="" && $amt!="")
			{
				...
				$query1= "UPDATE Customers  SET credits = credits + '$amt' WHERE Name = '$u2' ";
				$data1= mysqli_query($conn, $query1);
				$query2= "UPDATE  Customers SET credits = credits  - '$amt' WHERE Name = '$u1' ";
				$data2= mysqli_query($conn, $query2);
				
				//insert into transaction_history
				    $query1 = "INSERT INTO transfering_history (from_user,to_user,Credits) VALUES('$u1','$u2','$amt')";
